...
def writeconfigfile(marsfile,gribfullpath,dateparams,timestring):
    ...
    marswf.write('\n')
    marswf.write('levelist=800,')
    marswf.write('\n')
    marswf.write('levtype=pl,')
    marswf.write('\n')
    marswf.write('param=130.128/131/132/157.128,')
    marswf.write('\n')
...
if __name__ == "__main__":
    starttimestring='2018-10-13 00:00:00'
    ...
    for i in range(38):
        ...
        marsfile=marsroot+'/'+'power_pl_request_'+pdatetimestring+'.mars'
        gribfullpath=ecrootpath+'/'+yearstring+'/'+monthstring+'/pl_'+pdatetimestring+'.grib'
