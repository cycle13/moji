...
if __name__ == '__main__':
    ...
    for i in range(10):
        pdate=starttime+datetime.timedelta(days=i)
        pdatepath=datetime.datetime.strftime(pdate,'%Y%m%d')
        ...
        #oss.get_obj('moge/data/ecmwf/20180410/D1D04100000041003001.bz2',
        #            '/home/wlan_dev/tmp/D1D04100000041003001.bz2')
        oss.get_objs('moge/data/ecmwf/'+pdatepath, '/home/wlan_dev/tmp')
        e = time()
