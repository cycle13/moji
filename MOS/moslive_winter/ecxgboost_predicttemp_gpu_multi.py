...
def predictmodel(file,filefullpath,modelfile,scalefile,stationlist,demdict,origintime,foretime,gpu):
    ...
    # csvfile = open(csv, 'w')
    sql = 'replace into t_r_ec_city_forecast_ele_mos_dem_winter2 (city_id,initial_time,forecast_time,forecast_year,forecast_month,forecast_day,forecast_hour,temperature)VALUES(%s,%s,%s,%s,%s,%s,%s,%s)'
    L = []
...
if __name__ == "__main__":
    ...
    starttime = datetime.datetime.strptime('2018-10-02 12:00:00',
                                           '%Y-%m-%d %H:%M:%S')
