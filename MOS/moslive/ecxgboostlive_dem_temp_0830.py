...
def modelProdict(path,outpath,csvfile,demcsv,starttime):
    ...
    for i in range(len(bz2list001)):
        ...
        print modelname,tempscalerfile
...
if __name__ == "__main__":
    ...
    print outpath,csvfile,demcsv,starttime
    modelProdict('/mnt/data/2018-08-31',outpath,csvfile,demcsv,starttime)
