...
def GetStationsAndOnetimesFromEC(i,sfc_varinames,sfc_file,pl_varinames,pl_file,inputfile):
    ...
    for j in range(len(stationlist)):
        ...
        if trainlebel<>None and trainlebel<>999999:
            ...
            perstationlist=GetOnetimeFromEC(i,sfc_varinames,sfc_file,indexlat,indexlon,pl_varinames,pl_file)
...
scaler_file='/home/wlan_dev/model/scale'+str(ll)+'.save'
...
model.save_model('/home/wlan_dev/model/ectt'+str(ll)+'.model')
