...
description:
"""
import Nio, datetime, os,string,logging,xgboost,numpy,multiprocessing,sys
...
def modelprocess(ll):
    sys.stdout=open('/Users/yetao.lu/Desktop/mos/log/a'+str(ll)+'.out','w')
    ...
    def GetOnetimeFromEC(n,sfc_varinames,sfc_file,indexlat,indexlon,pl_varinames,pl_file):
        ...
        for i in range(len(sfc_varinames)):
            variArray=sfc_file.variables[sfc_varinames[ll]]
            #print len(variArray)
...
res=pool.map(modelprocess,range(4))
