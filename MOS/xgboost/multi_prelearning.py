...
def modellearning(ll):
    ...
    testfile='/home/wlan_dev/model/pre_test'+str(ll)+'.csv'
    predsfile='/home/wlan_dev/model/pre_preds'+str(ll)+'.csv'
    originfile='/home/wlan_dev/model/pre_origin'+str(ll)+'.csv'
...
for ll in range(65):
    processlist=[]
    p=multiprocessing.Process(target=modellearning,args=(ll,))
    p.start()
    processlist.append(p)
    for per in processlist:
        per.join()
