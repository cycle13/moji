...
author:     yetao.lu
date:       2018/2/23
description:  该方法是65次循环，对65次预报时次进行训练，用于本机测试的版本
"""
...
for ll in range(65):
    ...
    print '数据处理消耗时间'+str((endtime-starttime).seconds)
    #重新计算时间
    starttime=datetime.datetime.now()
    #xgboost
    ...
    model.save_model('/Users/yetao.lu/Desktop/mos/model'+str(ll)+'.model')
