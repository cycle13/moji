...
#xgboost
x_train,x_test,y_train,y_test,z_train,z_test=train_test_split(stationArray,trainlebelArray,kidArray,test_size=0.33,random_state=7)
...
print len(x_train),len(x_test),len(y_train),len(y_test),len(z_train),len(z_test)
#print xgbtest
#训练和验证的错误率
...
# model.save_model('/home/wlan_dev/model/ectemp'+str(ll)+'.model')
...
# originfw.close()
kidfile='/home/wlan_dev/model/kid'+str(ll)+'.csv'
