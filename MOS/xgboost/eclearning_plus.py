            ...
            if stationfile[i][-4:]=='.csv':
                ...
                while True:
                    ...
                    if not line:
                        break
    return stationdict
def GetOnetimeFromEC(n,sfc_varinames,sfc_file,latitude,longitude,alti,pl_varinames,pl_file):
    vstring=[]
...
def GetStationsAndOnetimesFromEC(i,sfc_varinames,sfc_file,pl_varinames,pl_file,inputfile):
    ...
    for j in range(len(stationlist)):
        ...
        if trainlebel<>None and trainlebel<>999999:
            ...
            perstationlist=GetOnetimeFromEC(i,sfc_varinames,sfc_file,latitude,longitude,alti,
...
if __name__ == '__main__':
    ...
    stationdict=getstationslist(tempcsv)
    #EC格点数据的获取
    ll=1
    ...
    scaler_file=os.path.join(outpath,'tscale'+str(ll)+'.save')
    ...
    outmodel=os.path.join(outpath,'tmodel'+str(ll)+'.model')
