...
description:
"""
import Nio, datetime, os,string,logging,xgboost,numpy
...
#数据在训练前进行归一化
permax=numpy.max(stationArray,axis=0)
permin=numpy.min(stationArray,axis=0)
gui1Array=(stationArray-permin)/(permax-permin)
#print gui1Array
stationArray=gui1Array
# columnnum=len(stationArray[0])
# for v in range(columnnum):
#     percolu=stationArray[:,v]
#     permin=percolu.min
#     permax=percolu.max
#     print percolu.type,permin,permax
#     newcolu={}
#     for h in range(len(percolu)):
#数据训练前进行标准化
