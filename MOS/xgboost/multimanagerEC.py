...
def modelprocess(stationdict,stationlist,ll):
    ...
    sfc_varinames = ['2T_GDS0_SF/moji/meteo/cluster/data/MOS/C', '2D_GDS0_SFC', '10U_GDS0_SFC','10V_GDS0_SFC','TCC_GDS0_SFC', 'LCC_GDS0_SFC']
    ...
    print mse0,rmse0,mae0,accuracy2_before,accuracy3_before,mse,rmse,mae,accuracy2_after,accuracy3_after,len(a_train),len(a_test)
...
if __name__=='__main__':
    ...
    csvfile = '/home/wlan_devi/t_p_station_cod.csv'
