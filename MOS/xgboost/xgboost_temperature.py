...
#EC格点数据的获取
for ll in range(65):
    sfc_varinames = ['2T_GDS0_SFC', '2D_GDS0_SFC', '10U_GDS0_SFC','10V_GDS0_SFC','TCC_GDS0_SFC', 'HCC_GDS0_SFC','LCC_GDS0_SFC',]
    ...
    print("RMSE: %.4f" % rmse0)
    print("MAE: %.4f" % mae0)
    model.save_model('/home/wlan_dev/model'+str(ll)+'.model')
    model.dump_model('/home/wlan_dev/dump'+str(ll)+'.txt')
    model.dump_model('/home/wlan_dev/dump'+str(ll)+'.txt','/home/wlan_dev/featmap'+str(ll)+'.txt')
    endtime=datetime.datetime.now()
    #print len(dict)
    print(endtime-starttime).seconds