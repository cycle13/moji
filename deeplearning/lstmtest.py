...
# data
mnist = input_data.read_data_sets("/Users/yetao.lu/2017/MNIST_data/", one_hot=True)
...
with tf.Session() as sess:
    sess.run(init)
    train_writer = tf.summary.FileWriter("/Users/yetao.lu/2017/train",sess.graph)
    test_writer = tf.summary.FileWriter("/Users/yetao.lu/2017/test",sess.graph)
    # training
    step = 1
    for i in range(2000):
        _batch_size = 128
