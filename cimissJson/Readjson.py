...
import xlwt
m=1
weatherfile='/Users/yetao.lu/Desktop/mos/t_p_station_cod.csv'
...
#print pdatetime
listdirs=os.walk('/Users/yetao.lu/Documents/SURF_HOUR_N/2018')
    ...
    for f in files:
        ...
        for i in range(len(datalist)):
            ...
            if stationid=='54399':
                ...
                odatetime=datetime.datetime(int(year),int(mon),int(day),int(hour),0)
                ...
                m=m+1
wbk.save('/Users/yetao.lu/Documents/weather.xls')
