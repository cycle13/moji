...
author:     yetao.lu
date:       2018/5/11
description:从气象局信息中心的接口中下载CLDAS数据6.25公里的，采用多进程下载
"""
...
def getcldasdata(outpath,logger):
    ...
    url = 'http://api.data.cma.cn:8090/api?userId=mjtq_mjtqmete_user&pwd=123456&interfaceId=getNafpFileByTime&dataCode=NAFP_CLDAS2.0_RT_NC&time=' + pdatestr + '&dataFormat=json'
