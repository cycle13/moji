...
author:     yetao.lu
date:       2018/9/17
description: 用EC逐小时的数据来重新插值光伏，发现比3小时的相关系数要高
"""
...
if __name__ == "__main__":
    ...
    powersun_check(ecfile,93.9203, 42.2439,powerstationname001,txtpath)
    # for root,dirs,files in os.walk(ecrootpath):
    #     for file in files:
    #         filename=os.path.join(root,file)
    #         if file[:3]=='sfc' and file[13:15]=='12':
    #             powersun_check(filename, 93.9203, 42.2439, powerstationname001,txtpath)
    #             powersun_check(filename,101.8403, 24.7708, 'YNCXDZ', txtpath)
