...
def weatherfeatureFromEC(lon,lat,powerstationname,txtpath):
...
if __name__ == "__main__":
    ...
    #weatherfeatureFromEC(114.0352, 40.4638, 'TZHCS', txtpath)
    #weatherfeatureFromEC(93.9203, 42.2439, 'XJHMSK', txtpath)
    #weatherfeatureFromEC(101.8403, 24.7708, 'YNCXDZ', txtpath)
    #定时任务部分
    executors = {
